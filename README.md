...
CREATE the file .env.local in the app root directory (not in the app folder!)
COPY the keys from clerk site (I logged in with github account):
NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_cmVsZXZhbnQtbGl6YXJkLTg2LmNsZXJrLmFjY291bnRzLmRldiQ
CLERK_SECRET_KEY=sk_test_C9kpUscTzoJueKoVDKb8ehMBvdomvnFIdfNSQFa5Kg

DID NOT WORK WITH INSTALLATION STEPS FROM COURSE!
